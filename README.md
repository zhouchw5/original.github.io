...
This research was to develop a mathematical model to simulate the stock index time series and predict the corresponding transition probability, with the examined Hurst exponent of the sampled Shanghai Composite Index consistent to the domestic research on fratal market.     
