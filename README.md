...
_To achieve the best strategy for demand fulfillment, my main job can be divided into three main modules: **Demand/Supply Mathch, Logistics Optimization** and **Allocations Management**._      
- Developed an iteration model computing the supply allocation for typical projects, by programming in Python Spyder and building up a visualization and interaction interface of data report in Tableau Desktop      
